...
const publicRoutes = ['/fr','/ar','/','/ar/auth/firstlogin','/auth/firstlogin','/fr/auth/firstlogin','/ar/auth/professionnels','/fr/auth/professionnels','/auth/professionnels','/ar/auth/medecins','/fr/auth/medecins','/auth/medecins','/fr/auth/jeunes','/ar/auth/jeunes','/auth/jeunes','/forgotPassword', '/ar/forgotPassword','/fr/forgotPassword', '/fr/register/jeunes', '/ar/register/jeunes','/register/jeunes',"/fr/register/medecins",'/ar/register/medecins','/register/professionnels','/fr/register/professionnels','/ar/register/professionnels']
