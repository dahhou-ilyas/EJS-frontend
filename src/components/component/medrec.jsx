      ...
      <div className="flex flex-1 border-t border-muted-foreground/20">
        <main className={`flex-1 p-8 ${theme === 'light' ? 'bg-[#e6f2ff]' : 'bg-gray-800'}`}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-8 justify-center">
            <Link href="/profile">
              <div className={`flex flex-col items-center p-4 space-y-2 border rounded-md ${theme === 'light' ? 'bg-background' : 'bg-gray-700'} shadow-md hover:bg-muted/50 transition-colors`}>
