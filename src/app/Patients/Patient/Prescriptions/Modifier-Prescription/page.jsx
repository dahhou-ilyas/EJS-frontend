...
const modifierPrescription = (props) => {
  ...
  const pages = ["Patients", "Patient", "Modifier Prescription"];
  return (
    <div id="root">
      <Sidebar activeClassName="patients" />
      <div className="page-wrapper">
        <div className="content">
          <NavigationHeader pages={pages} currentPage="Modifier Prescription" />
          <div className="row">
                    ...
                    <div className="row">
                      <div className="col-12">
                        <div className="form-heading">
                          <h4>Modifier New Prescription 1</h4>
                        </div>
                      </div>
...
export default modifierPrescription;
